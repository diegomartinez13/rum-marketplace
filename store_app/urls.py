...
urlpatterns = [
    ...
    path("product/<int:product_id>/toggle-sold-out/", views.toggle_sold_out_product, name="toggle_sold_out_product"),
    path("product/<int:product_id>/delete/", views.delete_product, name="delete_product"),
    path("service/<int:service_id>/toggle-sold-out/", views.toggle_sold_out_service, name="toggle_sold_out_service"),
